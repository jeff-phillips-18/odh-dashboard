...
const ConnectedExploreApplications: React.FC<ConnectedExploreApplicationsProps> = ({ components, getComponents, componentsLoading, componentsError }) => {
        ...
        <PageSection className="odh-explore-apps__error">
          <EmptyState variant={EmptyStateVariant.full}>
            ...
            <EmptyStateBody className="odh-explore-apps__error-body">
              <div>
                <code className="odh-explore-apps__display-error">{JSON.stringify(componentsError, null, 2)}</code>
              </div>
            </EmptyStateBody>
          </EmptyState>
        </PageSection>
